          ...
          <div className="bs-features">
      			<div className="row">
      				<div className="col-md-4">
      					...
      					<p>A responsive boilerplate optimized for the multi-screen web, with highly optimized. One framework, every device</p>
      				</div>
      			...
      			<div className="row">
      				...
      				<div className="col-md-4">
      					<span className="fa-stack fa-3x">
      						<i className="fa fa-circle fa-stack-2x"></i>
      						<i className="fa fa-folder-open fa-stack-1x fa-inverse"></i>
      					</span>
